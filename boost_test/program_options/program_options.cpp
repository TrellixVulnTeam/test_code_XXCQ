...
int main(int argc, char *argv[])
{
	...
	desc.add_options()("help", "produce help message")("compression", po::value<int>(&compression)->default_value(5), "set compression level") //automatically assign to a variable
		...
		("List0", po::value<std::vector<std::string>>(&Lists[0])->multitoken(), "List0.")("List1", po::value<std::vector<std::string>>(&Lists[1])->multitoken(), "List1.");
