...
int main(int argc, char *argv[])
{
    ...
    desc.add_options()("help", "produce help message")("compression", po::value<int>(&compression)->default_value(5),
        "set compression level")  // automatically assign to a variable
    ...
    if (vm.count("size"))
    {
        std::cout << "Size was set to " << vm["size"].as<double>() << std::endl;
    }
    else
    {
